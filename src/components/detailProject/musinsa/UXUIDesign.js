...
const UXUIDesign = () => {
    return (
        <ContentWrap>
            <Container>
                <UXUIDesignSection 
                    img={musinsaSources.UXUIDesign01} 
                    title="매거진과 스토어로" 
                    pointTitle=" 컨텐츠 분리" 
                    description=
                ...
                />
                <UXUIDesignSection 
                    img={musinsaSources.UXUIDesign02} 
                    title="쇼핑 서비스" 
                    pointTitle=" UX 단순화" 
                    description=
                ...
                />
                <UXUIDesignSection 
                    img={musinsaSources.UXUIDesign03} 
                    title="매거진" 
                    pointTitle="컨텐츠 통합" 
                    description=
                ...
                />
                <UXUIDesignSection 
                    img={musinsaSources.UXUIDesign04} 
                    title="상품 페이지" 
                    pointTitle=" UX 개선" 
                    description=
                    "상품 정보의 비중이 명확하게 나뉘어지도록 레이아웃. 또한 상품&가격 구성은 그리드로 감싸 한번 더 분리하여 밸런스 조정. 무신사의 대표 혜택인 ‘전상품 무료배송’은 가장 우선순위로 둠. 상품의 브랜드 로고는 배경 그래픽을 삭제하고, 상단 GNB에 포함시켜 깔끔하게 정리." 
                />
                <UXUIDesignSection 
                    img={musinsaSources.UXUIDesign05} 
                    title=" 무신사 단독 컨텐츠!" 
