...
const BgComponent01 = ({ isShow }) => {
    const [objTransform01, setObjTransform01] = useState(150);
    const [objTransform02, setObjTransform02] = useState(100);
    const [objTransform03, setObjTransform03] = useState(200);
